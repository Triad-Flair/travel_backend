...
class User(TimestampsMixin, BaseModel):
    ...
    date_of_birth: Mapped[str | None] = mapped_column("dateOfBirth", String(20), nullable=True)
    ...
    verification_tier: Mapped[str] = mapped_column("verification", String(20), default="BASIC", nullable=False)
